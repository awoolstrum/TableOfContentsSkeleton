<?php
  ...
  class DirectoryScanner
  {
    ...
    public  function __construct(
      ...
      $this->prepareFileExtensions();
    }

    public function prepareFileExtensions()
    {
      if(empty($this->validFileExtensions)) return;
      foreach($this->validFileExtensions as $k => $v ){
        $this->validFileExtensions[$k] = '.'.$v;
      }
      $this->printDebug('Valid File Extensions', $this->validFileExtensions);
    }
    ...
    protected function mapFileTree($startingDirectory)
    {
      ...
      if (! empty($directory)) {
        ...
        $this->printDebug("next directories parser", $nextDirectories);
      }
